...
/**
* <h1>GUI based Complex Number Calculator!</h1>
...
public class ComplexCalculator implements ActionListener
{
    ...
    ComplexCalculator ()
  {
    ...
    f.setTitle ("Complex Calculator GUI");
 ...
 */
   @Override public void actionPerformed (ActionEvent e)
  {
	...
	try
	{
	  ...
	  BufferedWriter bw =
	    new BufferedWriter (new
				FileWriter
				("C:\Users\D3VIL\Desktop\amity\megha\output.txt"));
	...
	try
	{
	  ...
	  runtime.exec
	    ("C:\\Windows\\notepad.exe C:\Users\D3VIL\Desktop\amity\megha\output.txt");
	...
	try
	{
	  ...
	  FileReader fr =
	    new FileReader ("C:\Users\D3VIL\Desktop\amity\megha\output.txt");
